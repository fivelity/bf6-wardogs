---
date created: Thursday, September 3rd 2026, 6:20:06 pm
date modified: Thursday, September 3rd 2026, 7:21:25 pm
---
...
*   **Three-Faction Setup**: 12-player teams (36-player maximum human lobby) [238, 248].
...
*   **The Programmatic 4th AI Faction (Chaos/Disruptor Squads)**:
...
*   **Score Ticking Mechanic**: A team scores points by holding the **majority player count** within the main Control Zone at the end of each 10s tick interval (monitored via progress bars on player HUDs) [250].
*   **Point Distribution**: Every 10s tick interval the team with the **majority player count** within the Control Zone/HotZone is given 1 Ticket. 
*   **HotZone (2x Presence + 1.5x Cash)**: Players that occupy the drifting HotZone will count as 2 Players when calculating the player count within the Control Zone and have a 1.5x multiplier added to their Cash rewards/progression track.
