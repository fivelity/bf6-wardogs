...
Events.OnGameModeStarted.subscribe(() => {
  ...
  // only its CapturePoint/AreaTrigger, which don't collide with anything.
  ...
  for (const objective of [controlZoneSector, towerASector, controlZoneCp, hotZoneCp, towerACp]) {
